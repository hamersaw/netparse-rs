...
impl IEEE802Dot11Frame {
    pub fn parse(cursor: &mut Cursor<Vec<u8>>) -> Result<IEEE802Dot11Frame, NetparseError> {
        ...
        let frame_type = match (packet_type, packet_subtype) {
            ...
            (0, 4) => IEEE802Dot11FrameType::MgmtProbeRequest(try!(MgmtProbeRequest::parse(cursor, to_ds, from_ds))),
            (0, 5) => IEEE802Dot11FrameType::MgmtProbeResponse(try!(MgmtProbeResponse::parse(cursor, to_ds, from_ds))),
            ...
            (2, 0) => IEEE802Dot11FrameType::Data(try!(Data::parse(cursor, to_ds, from_ds))),
            ...
            (2, 4) => IEEE802Dot11FrameType::DataNull(try!(DataNull::parse(cursor, to_ds, from_ds))),
            ...
            (2, 8) => IEEE802Dot11FrameType::DataQosData(try!(DataQosData::parse(cursor, to_ds, from_ds))),
